...
export const zhCN = {
  ...
  research: {
    title: "研究对照",
    subtitle: "影子表现跟踪：用真实后续价格验证过滤器本身是否有效",
    explain: "对被拦截、仅生成信号、实际成交三类决策抽取无偏样本，跟踪其在 7 个时间视野的价格变化。样本不足时不下结论（不制造精度）。",
    decision: "决策",
    horizon: "视野",
    eligible: "应采样",
    completed: "已采样",
    ...
    fSignaled: "仅信号",
    fExecuted: "已成交",
    empty: "尚无影子样本：需先积累决策记录（worker 每 2 分钟采样一次）",
    semantics: "「无样本」显示为 —（而非 0）：缺失与收益为 0 是两回事。",
  },
  common: {
    appName: "meme-bot",
    refresh: "刷新",
